...
from .data.config import (
    ...
    JOINTS_IDX,
    SMPL_FILE,
    JOINT_REGRESSOR_H36M_correct,
    SMPL_Female,
    SMPL_Male,
    SMPL_sampling_matrix,
)
...
class SMPL(nn.Module):
    ...
    def __init__(self, gender="neutral"):
        ...
        if gender == "m":
            model_file = SMPL_Male
        elif gender == "f":
            model_file = SMPL_Female
        else:
...
class Mesh(object):
    ...
    def __init__(self, filename=SMPL_sampling_matrix, num_downsampling=1, nsize=1, device=torch.device("cuda")):
